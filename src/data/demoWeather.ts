...
export function generateDemoWeek(startDate: string): DayData[] {
  const conditions: {
    ...
    { label: 'Clear', weatherCode: 0, cloudCover: 5, precipitation: 0, temp: 72 },
    { label: 'Cloudy', weatherCode: 3, cloudCover: 85, precipitation: 0, temp: 58 },
    { label: 'Rain', weatherCode: 61, cloudCover: 90, precipitation: 1.5, temp: 52 },
    { label: 'Heavy Rain', weatherCode: 65, cloudCover: 95, precipitation: 8, temp: 50 },
    { label: 'Snow', weatherCode: 73, cloudCover: 90, precipitation: 2, temp: 30 },
    { label: 'Freezing Rain', weatherCode: 66, cloudCover: 90, precipitation: 2, temp: 33 },
    { label: 'Fog', weatherCode: 45, cloudCover: 60, precipitation: 0, temp: 48 },
  ];
